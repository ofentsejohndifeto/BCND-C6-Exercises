...
var ExerciseC6CApp = artifacts.require("ExerciseC6CApp");                         // Add the reference to App contract
...
var Config = async function(accounts) {
    ...
    let exerciseC6CApp = await ExerciseC6CApp.new(exerciseC6C.address)                        // Variable that references that
    ...
    return {
        ...
        exerciseC6CApp: exerciseC6CApp,                                // pass contract as configuration variable ?? 
    }
}
